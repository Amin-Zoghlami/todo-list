...
export default class Input {
    ...
    #initializeElements() {
        ...
        this.#projectShow = document.querySelector(".show-project");
        this.#projectDialog = document.querySelector("dialog.project");
        this.#projectForm = document.querySelector("form.project");
        this.#projectSubmit = document.querySelector(".submit-project");
        this.#projectClose = document.querySelector(".close-project");

        this.#todoContainer = document.querySelector(".todo-container");
        this.#todoDialog = document.querySelector("dialog.todo");
        this.#todoForm = document.querySelector("form.todo");
        this.#todoSubmit = document.querySelector(".submit-todo");
        this.#todoClose = document.querySelector(".close-todo");

        this.#detailsDialog = document.querySelector("dialog.details");
        this.#detailsClose = document.querySelector(".close-details");
    }
